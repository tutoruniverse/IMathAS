...
<script defer="defer" type="module" src="<?php echo $staticroot;?>/assess2/vue/js/index.js?v=CoAwTriv"></script>
<script defer="defer" nomodule src="<?php echo $staticroot;?>/assess2/vue/js/index-legacy.js?v=BO4c1UoA"></script>
