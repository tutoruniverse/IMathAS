...
function clean_up($marray, $pixtox, $pixtoy) {
    foreach ($marray as $key => $value) {
        $marray[$key] = $pixtox(floatval(preg_replace("/[^0-9.\-]/", "", $value)));
    }
    return $marray;
}
...
function fans_polygons($mh, $mk, $mx, $my, $type, $pixtox, $pixtoy) {
    ...
    list($mh, $mk, $mx, $my) = clean_up(array($mh, $mk, $mx, $my), $pixtox, $pixtoy);
...
function fans_exps ($mh, $mk, $mx, $my, $m4, $m5, $type, $xop, $yop, $pixtox, $pixtoy) {
    ...
    list($mh, $mk, $mx, $my, $m4, $m5, $xop, $yop) = clean_up(array($mh, $mk, $mx, $my, $m4, $m5, $xop, $yop), $pixtox, $pixtoy);
...
function fans_ineqlines ($mh, $mk, $mx, $my, $mx2, $my2, $type, $pixtox, $pixtoy) {
    ...
    list($mh, $mk, $mx, $my, $mx2, $my2) = clean_up(array($mh, $mk, $mx, $my, $mx2, $my2), $pixtox, $pixtoy);
...
function fans_dots1d ($mh, $pixtox, $pixtoy) {
    ...
    list($mh) = clean_up(array($mh), $pixtox, $pixtoy);
