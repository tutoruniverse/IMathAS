...
// rolldownOptions (used below) requires Vite 8+
const viteMajorVersion = parseInt(viteVersion.split('.')[0], 10);
if (viteMajorVersion < 8) {
  throw new Error(`This config requires Vite 8 or higher (found ${viteVersion}).`);
}
