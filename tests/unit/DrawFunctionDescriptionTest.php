...
final class DrawFunctionDescriptionTest extends TestCase
{
    ...
    public function testFansLinesBasic()
    {
        ...
        $this->assertEquals("line: y = 2 * x", $result[0]);
    }
    ...
    public function testFansLinesWithIntercept()
    {
        ...
        $this->assertEquals("line: y = x + 2", $result[0]);
    }
    ...
    public function testFansLinesNonTrivial()
    {
        ...
        $this->assertEquals("line: y = 3 * x + 2", $result[0]);
    }
    ...
    public function testFansLinesNegativeSlope()
    {
        ...
        $this->assertEquals("line: y = -2 * x + 4", $result[0]);
    }
    ...
    public function testFansLinesNegativeSlopeAndIntercept()
    {
        ...
        $this->assertEquals("line: y = -2 * x - 1", $result[0]);
    }
    ...
    public function testFansLinesZeroSlope()
    {
        ...
        $this->assertEquals("line: y = 8", $result[0]);
    }
    ...
    public function testFansVecsRay()
    {
        ...
        $this->assertEquals("ray: y = x from x = 0, ", $result[0]);
    }
    ...
    public function testFansVecsSegment()
    {
        ...
        $this->assertEquals("segment: y = x from x = 0 -> 4, ", $result[0]);
    }
    ...
    public function testFansVecsVector()
    {
        ...
        $this->assertEquals("vector: y = x from x = 1 -> 3, ", $result[0]);
    }
    ...
    public function testFansParabsVertexAtOrigin()
    {
        ...
        $this->assertEquals("parabola: y = x^2", $result[0]);
    }
    ...
    public function testFansParabsWithOffset()
    {
        ...
        $this->assertEquals("parabola: y = (x + 1)^2 + 2", $result[0]);
    }
    ...
    public function testFansParabsPositiveAWithOffset()
    {
        ...
        $this->assertEquals("parabola: y = 2 * (x - 3)^2 - 2", $result[0]);
    }
    ...
    public function testFansParabsNegativeA()
    {
        ...
        $this->assertEquals("parabola: y = -(x + 2)^2 + 1", $result[0]);
    }
    ...
    public function testFansHparabsBasic()
    {
        ...
        $this->assertEquals("horizontal parabola: x = y^2", $result[0]);
    }
    ...
    public function testFansHparabsNonIntegerA()
    {
        ...
        $this->assertEquals("horizontal parabola: x = 0.25 * (y + 3)^2 + 1", $result[0]);
    }
    ...
    public function testFansSqrtsBasic()
    {
        ...
        $this->assertEquals("sqrt: y = sqrt(x)", $result[0]);
    }
    ...
    public function testFansSqrtsWithOffsetAndScaling()
    {
        ...
        $this->assertEquals("sqrt: y = 2 * sqrt(x + 1) + 2", $result[0]);
    }
    ...
    public function testFansCubicsBasic()
    {
        ...
        $this->assertEquals("cubic: y = x^3", $result[0]);
    }
    ...
    public function testFansCubicsNonUnitA()
    {
        ...
        $this->assertEquals("cubic: y = (2 * (x - 1))^3 + 2", $result[0]);
    }
    ...
    public function testFansCuberootsBasic()
    {
        ...
        $this->assertEquals("cube root: x = y^3", $result[0]);
    }
    ...
    public function testFansCuberootsWithOffset()
    {
        ...
        $this->assertEquals("cube root: x = (y - 2)^3 - 1", $result[0]);
    }
    ...
    public function testFansCuberootsNonUnitA()
    {
        ...
        $this->assertEquals("cube root: x = y^3 / 8", $result[0]);
    }
    ...
    public function testFansCircsRadiusThree()
    {
        ...
        $this->assertEquals("circle: x^2 + y^2 = 9", $result[0]);
    }
    ...
    public function testFansCircsWithCenter()
    {
        ...
        $this->assertEquals("circle: (x - 1)^2 + (y - 2)^2 = 9", $result[0]);
    }
    ...
    public function testFansCircsNonOriginCenter()
    {
        ...
        $result = fans_circs(1, -2, 4, 2, $this->pixtox, $this->pixtoy);
        $this->assertEquals("circle: (x - 1)^2 + (y + 2)^2 = 25", $result[0]);
    }
    ...
    public function testFansVhyperbolasBasic()
    {
        ...
        $this->assertEquals(
            "vertical hyperbola: y^2 / 4 - x^2 / 9 = 1",
            $result[0]
        );
    }
    ...
    public function testFansVhyperbolasOffCenter()
    {
        ...
        $this->assertEquals(
            "vertical hyperbola: (y + 2)^2 / 4 - (x - 1)^2 / 9 = 1",
            $result[0]
        );
    }
    ...
    public function testFansHhyperbolasBasic()
    {
        ...
        $this->assertEquals(
            "horizontal hyperbola: x^2 / 9 - y^2 / 4 = 1",
            $result[0]
        );
    }
    ...
    public function testFansHhyperbolasOffCenter()
    {
        ...
        $this->assertEquals(
            "horizontal hyperbola: (x + 2)^2 / 16 - (y - 1)^2 / 9 = 1",
            $result[0]
        );
    }
    ...
    public function testFansAbsBasic()
    {
        ...
        $this->assertEquals("abs: y = abs(x)", $result[0]);
    }
    ...
    public function testFansAbsNegativeSlope()
    {
        ...
        $this->assertEquals("abs: y = -abs(x - 2) + 4", $result[0]);
    }
    ...
    public function testFansAbsNonOriginVertex()
    {
        ...
        $this->assertEquals("abs: y = abs(x + 3) + 1", $result[0]);
    }
    ...
    public function testFansAbsFractionalSlope()
    {
        ...
        $this->assertEquals("abs: y = 0.5 * abs(x - 2) + 3", $result[0]);
    }
    ...
    public function testFansAbsNegativeA()
    {
        ...
        $this->assertEquals("abs: y = -abs(x - 1) + 4", $result[0]);
    }
    ...
    public function testFansRatsBasic()
    {
        ...
        $this->assertEquals("rational: y = 6 / x", $result[0]);
    }
    ...
    public function testFansRatsOffCenterAsymptotes()
    {
        ...
        $this->assertEquals("rational: y = 8 / (x - 2) + 3", $result[0]);
    }
    ...
    public function testFansExpsUnitCoefficient()
    {
        ...
        $this->assertEquals("exponential: y = 2^(x)", $result[0]);
    }
    ...
    public function testFansCossBasic()
    {
        ...
        $this->assertEquals("cosine: y = 2 * cos(x)", $result[0]);
    }
    ...
    public function testFansCossWithVerticalShiftAndPhase()
    {
        ...
        $this->assertEquals("cosine: y = 2 * cos(x - 2) + 1", $result[0]);
    }
    ...
    public function testFansCossNonUnitFrequency()
    {
        ...
        $this->assertEquals("cosine: y = 2 * cos(1.570796 * x) + 1", $result[0]);
    }
    ...
    public function testFansSinsBasic()
    {
        ...
        $this->assertEquals("sine: y = 2 * sin(1.570796 * x)", $result[0]);
    }
    ...
    public function testFansSinsNegativeAmplitude()
    {
        ...
        $this->assertEquals("sine: y = -3 * sin(1.570796 * x)", $result[0]);
    }
    ...
    public function testFansSinsWithOffset()
    {
        ...
        $this->assertEquals("sine: y = 2 * sin(0.785398 * (x + 1)) + 3", $result[0]);
    }
    ...
    public function testFansTanBasic()
    {
        ...
        $this->assertEquals("tangent: y = tan(0.785398 * x)", $result[0]);
    }
    ...
    public function testFansTanWithOffsetCenterAndAmplitude()
    {
        ...
        $this->assertEquals(
            "tangent: y = 2 * tan(0.785398 * (x + 1)) + 2",
            $result[0]
        );
    }
    ...
    public function testFansTanUnitAmplitudeWithOffset()
    {
        ...
        $this->assertEquals("tangent: y = tan(0.785398 * (x - 2)) + 3", $result[0]);
    }
